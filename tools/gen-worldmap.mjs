...
// projection, which re-projects at render time. FINE mirrors WORLD_PATH_FINE,
// for the zoomed-in globe.
...
// Internal borders as [lon, lat] polylines, for the globe.
export const BORDER_LINES: readonly (readonly (readonly [number, number])[])[] = ${borderLinesJson}

// Islet positions (lon, lat) for the globe — same cities as ISLETS_PATH.
