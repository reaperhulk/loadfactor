...
const globeOut = `{"$comment":"Generated by tools/gen-worldmap.mjs. Natural Earth 1:50m, public domain.","WORLD_RINGS":${ringsJson},"WORLD_RINGS_FINE":${ringsFineJson},"BORDER_LINES":${borderLinesJson},"ISLET_POINTS":${JSON.stringify(isletPoints)}}\n`
writeFileSync(join(root, 'src/data/globemap.gen.json'), globeOut)
console.log(
