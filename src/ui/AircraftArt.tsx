...
export function aircraftGlyph(type: string): string {
  ...
  if (t.seats >= 280) return 'M-11,-2 L-2,-2 L-5,-12 L-1,-12 L5,-3 L13,-1 L15,0 L13,1 L5,3 L-1,12 L-5,12 L-2,2 L-11,2 L-14,6 L-16,6 L-14,0 L-16,-6 L-14,-6Z'
...
export function AircraftArt({ type }: { type: string }) {
  const t = getAircraftType(type)
  const wide = t.seats >= 280, supersonic = type === 'concorde', prop = type === 'cv240'
