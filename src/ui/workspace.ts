export type WorkspacePage = 'desk' | 'map' | 'routes' | 'airports' | 'fleet' | 'orders' | 'catalog' | 'finance' | 'outlook' | 'rivals' | 'report'
...
export const AREA_PAGES: Record<WorkspaceArea, readonly WorkspacePage[]> = {
  ...
  fleet: ['fleet', 'orders', 'catalog'], company: ['finance', 'outlook', 'rivals', 'report'],
}
