...
export function DisplaySettings() {
  ...
  return <details className="display-settings" data-testid="display-settings"><summary>Display</summary>
    ...
    <label>Motion <select aria-label="motion preference" value={preferences.motion} onChange={(e) => setDisplayPreferences({ motion: e.target.value as DisplayPreferences['motion'] })}><option value="system">Use device setting</option><option value="reduced">Reduced motion</option><option value="full">Full motion</option></select></label>
